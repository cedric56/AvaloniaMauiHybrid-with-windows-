...
#endif
    {
        return appBuilder
            .AfterSetup(appBuilder =>
            {
                ...
                //builder.Services.RemoveAt(20);
                //builder.Services.RemoveAt(25);
                ...
                var thread = new Thread(() =>
                {
                    ...
                    {var uiContext = new Microsoft.UI.Dispatching.DispatcherQueueSynchronizationContext(Microsoft.UI.Dispatching.DispatcherQueue.GetForCurrentThread());
                    SynchronizationContext.SetSynchronizationContext(uiContext);
                        new Maui.AvaloniaMaui.WinUI.App();
                    });
                });
