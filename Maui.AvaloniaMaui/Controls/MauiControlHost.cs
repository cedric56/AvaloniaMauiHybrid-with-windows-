...
public class MauiControlHost : NativeControlHost
{
    ...
    protected override IPlatformHandle CreateNativeControlCore(IPlatformHandle parent)
    {
        ...
        {
#if IOS
            ViewController = ((Avalonia.iOS.UIViewControlHandle)parent).View.Window.RootViewController,
#endif
        };
...
#if ANDROID
        return new Avalonia.Android.AndroidViewControlHandle(native);
#elif IOS
        return new Avalonia.iOS.UIViewControlHandle(native);
#endif
#elif WINDOWS10_0_19041_0_OR_GREATER
        var app = Microsoft.Maui.Controls.Application.Current;
//        Microsoft.Maui.Controls.Application.Current.Handler = new ApplicationHandler();
